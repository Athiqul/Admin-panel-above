...
class CustomerReview extends BaseController
{
    public function index()
    {
        ...
        $url=getenv('API_LINK')."/review/show-all-reviews?page=".$getPage;
        $data=[
        ...
        return view('review/review',['response'=>$response,'page'=>$page,'current'=>$current]);
    ...
    public function create()
    {
        ...
        if($this->request->getPost())
        {
            ...
            $url=getenv('API_LINK')."/review/add-review";
            $response=$this->apiCalling($url,"POST",$data);
            //dd($response);
            ...
            return redirect()->to('/admin/customer-reviews')->with('success',$response->msg);
    ...
    public function update($id)
    {
        ...
        if($this->request->getPost())
        {
            ...
            // dd($data);
            $url=getenv('API_LINK')."/review/update-review/".$id;
            $response=$this->apiCalling($url,"POST",$data);
           ...
           return redirect()->to('/admin/show-review/'.$id)->with('success',$response->msg);
        }
        $url=  getenv('API_LINK')."/review/show-review/".$id;
        ...
        return view('review/update-review',['review'=>$response]);    
    }
    public function show($id)
    {
        ...
        $url=  getenv('API_LINK')."/review/show-review/".$id;
           ...
           if($response->errors==true)
         {
           ...
           return view('review/review-detail',['review'=>$response]); 
    }
     ...
     public function imageUpdate($id)
    {
            if($this->request->getPost())
            {
                ...
                if($file->isValid()==true)
                {
                    ...
                    {
                      $path=WRITEPATH.'uploads/reviews/'.$this->request->getVar('image');
    ...
    public function image($image_link)
    {
        ...
        if($image_link!=="")
    {
        $path= WRITEPATH.'uploads/reviews/'.$image_link;
